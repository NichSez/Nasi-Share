...
//                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(SearchFragment.TAG, "Intent----------- " + uri);
    ...
    public static class FileServerAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                Log.d(SearchFragment.TAG, "Server: Socket opened");
                Socket client = serverSocket.accept();
                Log.d(SearchFragment.TAG, "Server: connection done");
                ...
                if (!dirs.exists())
                    dirs.mkdirs();
                f.createNewFile();
                Log.d(SearchFragment.TAG, "server: copying files " + f.toString());
    ...
    public static boolean copyFile(InputStream inputStream, OutputStream out) {
        ...
        try {
            ...
            Log.d(SearchFragment.TAG, e.toString());
            return false;
        }
        return true;
    }
